const BtnDarkMode = () => {
  ...
  return (`
    <button id="btnDark" class="bg-[#111729] p-1 grid gap-2 grid-cols-2 rounded-3xl">
      <svg class="text-[#F2F9FE] dark:bg-[#F2F9FE] dark:text-[#111729] rounded-[50%]" width="28" height="28" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <svg class="bg-[#F2F9FE] dark:bg-[#111729] dark:text-[#F2F9FE] p-1 rounded-[50%]" width="28" height="28" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
